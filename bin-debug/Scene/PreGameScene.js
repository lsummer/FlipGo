...
var PreGameScene = (function (_super) {
    ...
    function PreGameScene() {
        ...
        _this.sequenceList = [[0, 0]]; // 生成本次游戏的游戏类型序列
        ...
        // this.init();
        _this.createBackGroundImageA();
        _this.createButtonImageA();
        _this.createTitle();
        return _this;
    }
    PreGameScene.prototype.createBackGroundImageA = function () {
    ...
    PreGameScene.prototype.createTitle = function () {
    ...
    PreGameScene.prototype.createButtonImageA = function () {
    ...
    // 初始化(给开始按钮绑定点击事件)
    PreGameScene.prototype.init = function () {
    ...
    PreGameScene.prototype.selectBgPopAdver = function () {
        this.bg_select = [];
    ...
    PreGameScene.prototype.judgeBackAdver = function () {
        if (SceneMange.gameSceneSetting[this.sequenceList[Math.floor(this.sequence_index / 5)][this.sequence_index % 5]].backgroud) {
    ...
    PreGameScene.prototype.selectNextType = function () {
        var tousetype;
    ...
    PreGameScene.prototype.addBackgroundAder = function () {
    ...
    PreGameScene.prototype.addBlock = function () {
        var _this = this;
    ...
    PreGameScene.prototype.createGameScript = function () {
        if (!this.GameSprite) {
    ...
    // 按下的事件逻辑
    PreGameScene.prototype.onKeyDown = function () {
        this.jumpDistance = 0;
        if (!this.circle) {
    ...
    PreGameScene.prototype.onSoundComplete = function () {
    ...
    // 放开
    PreGameScene.prototype.onKeyUp = function () {
        var _this = this;
        this.pushSoundChannel.stop();
    ...
    Object.defineProperty(PreGameScene.prototype, "factor", {
        get: function () {
            return 0;
        },
        set: function (value) {
    ...
    PreGameScene.prototype.createAddScoreMoment = function (score, left, right) {
        var _this = this;
        if (!this.scoreAdd) {
    ...
    PreGameScene.prototype.createReduceScoreMoment = function (score) {
        var _this = this;
        if (!this.scoreAdd) {
            this.scoreAdd = new egret.TextField();
        }
    ...
    PreGameScene.prototype.judgeResult = function () {
        var _this = this;
        if (SceneMange.gameSceneSetting[this.sequenceList[Math.floor(this.sequence_index / 5)][this.sequence_index % 5]].popUp) {
        ...
        if (judgement == 1) {
            ...
            egret.Tween.get(this.player).to({}, 500).to({
                ...
                egret.Tween.get(_this).to({ factor: 1 }, 500, egret.Ease.sineIn).call(function () {
                    ...
                    // 随机下一个方块出现的位置
                    // this.direction = Math.random() > 0.5 ? 1 : -1;
                    if (_this.hasBackgroudAdver && (_this.sucess - _this.lastsucess) <= _this.intervel_back + 3) {
                        console.log("不换方向");
                    }
                    else {
    ...
    PreGameScene.prototype.createEndScript = function () {
        if (!this.EndSprite) {
    ...
    PreGameScene.prototype.FallorSuccess = function () {
    ...
    PreGameScene.prototype.IfinSqure = function (block) {
        var sizeX = 140 * 2;
        var sizeY = 140 * 1.1;
        var k = sizeY / sizeX;
    ...
    PreGameScene.prototype.update = function (x, y) {
    ...
    PreGameScene.prototype.createBoxArray = function () {
        this.boxTypeArray = [];
    ...
    PreGameScene.prototype.createPlayer = function () {
    ...
    PreGameScene.prototype.createBackGroundImage = function () {
        var bg = new egret.Shape();
        bg.graphics.clear();
        bg.graphics.beginFill(0xD3D3E6);
    ...
    PreGameScene.prototype.reSet = function () {
        // 重新开始一局
    ...
    PreGameScene.prototype.onComplete = function (event) {
        var loader = event.target;
        var data = loader.data;
        console.log(data.toString());
    };
    PreGameScene.prototype.onGetComplete = function (event) {
    ...
    PreGameScene.prototype.onGetIOError = function (event) {
        console.log(event);
    };
    PreGameScene.prototype.onGetProgress = function (event) {
        console.log("get progress : " + Math.floor(100 * event.bytesLoaded / event.bytesTotal) + "%");
    };
    PreGameScene.prototype.createScore = function () {
        if (!this.scoreScene) {
    ...
    PreGameScene.prototype.Scores = function (desc, score, loca) {
    ...
    // 结束画面
    PreGameScene.prototype.createEndSceneScore = function () {
    ...
    PreGameScene.prototype.createEndSceneBackGroundImage = function () {
        var bg = new egret.Shape();
        bg.graphics.clear();
    ...
    PreGameScene.prototype.createNextButtonImage = function () {
    ...
    PreGameScene.prototype.createEndSceneButtonImage = function () {
        if (!this.replay) {
    ...
    PreGameScene.prototype.transfer = function () {
        if (this.sequence_index == 1) {
            this.removeChildren();
            var palyMethod = new PlayMethod(); // 玩法说明
    ...
    PreGameScene.prototype.beginButton = function () {
        var beginB = new egret.Bitmap();
        beginB.texture = RES.getRes("button_png");
        beginB.width = beginB.width / 2;
        beginB.height = beginB.height / 2;
    ...
    PreGameScene.prototype.createButtonImage = function () {
        var beginB = new egret.Bitmap();
        beginB.texture = RES.getRes("button_png");
        beginB.width = beginB.width / 2;
        beginB.height = beginB.height / 2;
    ...
    PreGameScene.prototype.createQuesBackGroundImage = function () {
        var bg = new egret.Shape();
        bg.graphics.clear();
    ...
    PreGameScene.prototype.updateQuestion = function () {
        ...
        switch (this.progress) {
            ...
            default:
                ...
                this.removeChildren();
                this.createQuesBackGroundImage();
                var progere = new TransferScreen("第 2 部分 - 正式实验", "开始 2 组正式实验", "gameScene");
                this.addChild(progere);
                console.log("结果：", SceneMange.uploadMessage);
                break;
        }
    };
    PreGameScene.prototype.createQuestionAndAnswers = function (quest, answe, num) {
    ...
    //     }
    // }
    PreGameScene.prototype.beginButtonTap = function () {
    ...
    PreGameScene.prototype.addBanner = function () {
        // if(!this.banusAdver){
    ...
    // 添加pop-up广告
    PreGameScene.prototype.addPopUpAdvertisement = function () {
    ...
    PreGameScene.prototype.addjili = function () {
        if (!this.awardAdver) {
    ...
    PreGameScene.prototype.tapjili = function () {
        this.touchUnable();
        console.log("触发激励视频");
        egret.clearTimeout(this.intervalID);
    ...
    PreGameScene.prototype.createShutDown = function (func) {
    ...
    PreGameScene.prototype.shutdown_pop = function () {
    ...
    PreGameScene.prototype.shutdown = function () {
    ...
    PreGameScene.prototype.createAdd10TweenAndAudio = function (scoreAdd) {
    ...
    PreGameScene.prototype.createChoosePannel = function () {
        var _this = this;
    ...
    PreGameScene.prototype.SetIntervalExample = function () {
        this.intervalID = egret.setTimeout(this.myRepeatingFunction, this, this.intervalDuration);
    };
    PreGameScene.prototype.myRepeatingFunction = function (obj) {
    ...
    PreGameScene.prototype.touchUnable = function () {
        if (this.GameSprite) {
            this.GameSprite.touchEnabled = false;
        }
        if (this.awardAdver) {
    ...
    PreGameScene.prototype.touchEnable = function () {
        if (this.GameSprite) {
            this.GameSprite.touchEnabled = true;
        }
        if (this.awardAdver) {
